...
async function delCase() {
    ...
    // parent component will delete the case after receiving the emit.
...
<template>
    ...
    <div class="col-md-10 col-sm-12">
        <form id="user-query" @submit.prevent="onSubmit" @keydown="handleKeyDown">
            <div class="container d-grid row-gap-3" @drop.prevent="onSelect">
                ...
                <div class="row mt-2" style="position: relative;">
                    ...
                    <div class="col-10">
                        ...
                        <label for="user-query" class="bottom-btn" @click.prevent="selectFiles.click()">
                        ...
                        <label  for="user-query" class="bottom-btn" @click.prevent="openModal">
                            <IconLink />
                        </label>
                        <label  for="user-query" class="bottom-btn" @click.prevent="keywords = ''; filesUpload = []; checkboxNoHistory = false">
